  ...
  return (
    <Dropdown
      ...
      classNames={{
        ...
        content: "p-0 border-small border-divider bg-background w-60",
      }}
      radius="sm"
    >
      <DropdownTrigger>
      ...
      >
        <DropdownSection showDivider aria-label="Profile & Actions">
          ...
          <DropdownItem key="project" href="/project">Projects</DropdownItem>
        ...
        <DropdownSection aria-label="Help & Feedback">
          <DropdownItem key="help_and_feedback">Help & Feedback</DropdownItem>
          <DropdownItem key="logout" className="p-0 mt-4"><ReusbleButton title="Hire Me"  className="w-full rounded"/></DropdownItem>
        </DropdownSection>
      </DropdownMenu>
    </Dropdown>
  );
